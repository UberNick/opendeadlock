...
/*
 * Posted by tggtt 2014-01-29
 * BinLoader is possibly the simplest tool around. It allows to copy a binary 
 * file (such as the ones generated by palettetool) into a larger binary file. 
 * It is very simple and was created to allow quick loading of single images 
 * into sprite files. The great deal with BinLoader was actually the address
 * parsing of decoded graphics files.
*/
